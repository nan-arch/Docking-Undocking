var background,sleep,brush,gym,eat,bath,drink,move;
var astronaut;
...
function draw() {
  ...
  if(keyDown("UP_ARROW")){
    ...
    astronaut.changeAnimtion("brushing");
    astronaut.y = 350;
  ...
  if(keyDown(DOWN_ARROW)){
    ...
    astronaut.changeAnimtion("gymming");
    astronaut.y = 350;
    astronaut.velocityX = 0;
    astronaut.velocityY = 0;
  ...
  if(keyDown("LEFT_ARROW")){
    ...
    astronaut.changeAnimtion("eating");
    astronaut.x = 150;
  ...
  if(keyDown("RIGHT_ARROW")){
    ...
    astronaut.changeAnimtion("bathing");
    astronaut.x = 300;
    astronaut.velocityX = 0;
    astronaut.velocityY = 0;
  ...
  if(keyDown("m")){
    ...
    astronaut.changeAnimtion("moving");
